...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Primary brand colors - Sunset theme
        brand: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
      ...
      backgroundImage: {
        ...
        'gradient-celebration': 'linear-gradient(135deg, #f97316 0%, #06b6d4 50%, #84cc16 100%)',
        'gradient-sunset': 'linear-gradient(135deg, #f97316 0%, #ea580c 100%)',
        'gradient-ocean': 'linear-gradient(135deg, #06b6d4 0%, #0891b2 100%)',
        'gradient-nature': 'linear-gradient(135deg, #84cc16 0%, #65a30d 100%)',
      },
      backdropBlur: {
        xs: '2px',
      },
